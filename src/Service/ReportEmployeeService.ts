...
const FindByIdSends = (id: string) => SendReportModel.find({admin_id: id}).populate("report_id").populate("employee_id");
const FindByIdSendsEmployee = (id: string) => SendReportModel.find({employee_id: id}).populate("report_id").populate("employee_id");
const FindById = (id: string) => ReportEmployeeModel.find({employee_id: id});
